...
const Contact = () => {
  return (
    <div className="mt-5" id="contact">
      <div className="grid grid-cols-1 lg:grid-cols-2  md:px-10 gap-6">
        {/* Left side content */}
        <Card className="flex flex-col items-center p-4 md:p-8 mx-4 text-black">
          <div>
            <h2 className="font-Telugu text-center font-semibold text-2xl text-heading">
              సంప్రదించండి
            </h2>
          </div>
            ...
            <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="w-full">
                ...
                <p className="text-base text-body-color">
                  ...
                  >
                    kotilingalamahakaleswara@gmail.com
                  </a>
                  <a
                    href="mailto:kotilingalamahakaleswara@gmail.com"
                    className="block md:hidden"
                  >
                    kotilingalamahakaleswara<p>@gmail.com</p>
                  </a>
                </p>
              </div>
            </div>
        ...
        <div className="p-4 md:p-8 flex items-center">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3829.408780269849!2d80.42969567489877!3d16.302044333163682!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a4a7569d6d11883%3A0x7d7d0342a7103af1!2sOmkara%20Kshetram!5e0!3m2!1sen!2sin!4v1692941599511!5m2!1sen!2sin"
